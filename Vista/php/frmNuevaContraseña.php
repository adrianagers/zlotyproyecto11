            ...
            <div class="container divInterno">
                <div class="row">
                    ...
                    <div class="col-lg-6  p-5 ">
                        ...
                        <!-- titulo principal -->
                        <section>
                            <h1 class="tituloInicio">Continúa el proceso para restablecer tu contraseña</h1>
                            
                            <h4 class="dinosEmail">Ingresa tu nueva contraseña</h4>
                        </section>
                        <!-- formulario  -->
                        <form action="../../Controlador/CcambiarContraseña.php" method="post">

                            <!-- email -->
                            <div class="form-group  ml-5">
                                <label for="password" class="colorLabel">Nueva Contraseña</label>
                                <input type="password" class="form-control inputPeque" name="password1"  required>
                                <label for="password" class="colorLabel">Repite la Contraseña</label>
                                <input type="password" class="form-control inputPeque" name="password2"  required>
                                <input type="hidden" class="form-control inputPeque" name="correo" id="correo" value="<?php echo $email?>"
                                    readonly>
